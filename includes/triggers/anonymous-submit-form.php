...
class AutomatorWP_FluentForm_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-fluentform' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-fluentform' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-fluentform' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-fluentform' ), '{post}' ),
